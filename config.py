...
def get_config():
    ...
    parser.add_argument("--num_env_steps", type=int, default=180000,
    ...
    parser.add_argument("--demand", type=str, default="saturated", choices=["undersaturated", "saturated", "oversaturated"],
                        help="Traffic demand scenario (selects a SUMO route file under sumo/).")
    parser.add_argument("--route_file", type=str, default=None,
                        help="Override SUMO route file (path). If set, --demand is ignored.")


    parser.add_argument("--use_obs_instead_of_state", action='store_true',
                        default=False, help="Whether to use global state or concatenated obs")

    #NEW: episode_length=120s for training and episode_length=7200 for evaluation
    parser.add_argument("--episode_length", type=int,
                        default=300, help="Max length for any episode")
    parser.add_argument("--eval_episode_length", type=int,
                        default=7200, help="Max length for evaluation episode")
    ...
    # pretrained parameters
    #parser.add_argument("--model_dir", type=str, default=None, help="by default None. set the path to pretrained model.", choices=['../models', None])
    #NEW Allow arbitrary model directory paths (do NOT restrict with 'choices').
    # Example: --model_dir /abs/path/to/results/.../models
    parser.add_argument(
        "--model_dir",
        type=str,
        default=None,
        #default=r"C:\mytest\Communications_in_Transportation_Research\1stround\5.2pro\mappo\results\MyEnv\MyEnv\mappo\check\run205\models",
        help="Path to a pretrained model directory (e.g., .../models).",
    )
